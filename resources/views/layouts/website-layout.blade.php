...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('website') }}/assets/css/templatemo-finance-business.css">
            ...
            <div class="item item-2">
                <div class="img-fill">
                    <div class="text-content">
                        ...
                        <p>You are allowed to use this template for your company websites. You are NOT allowed to
                            re-distribute this template ZIP file on any template download website. Please contact
                            TemplateMo for more detail.</p>
            ...
            <div class="item item-3">
                <div class="img-fill">
                    <div class="text-content">
                        ...
                        <p>You can download, edit and use this layout for your business website. Phasellus lacinia ac
                ...
                <div class="col-md-12">
                    <div class="owl-partners owl-carousel">
                        ...
                        <div class="partner-item">
                            <img src="{{ asset('website') }}/assets/images/client-01.png" title="1" alt="1">
                        </div>

                        <div class="partner-item">
                            <img src="{{ asset('website') }}/assets/images/client-01.png" title="2" alt="2">
                        </div>

                        <div class="partner-item">
                            <img src="{{ asset('website') }}/assets/images/client-01.png" title="3" alt="3">
                        </div>

                        <div class="partner-item">
                            <img src="{{ asset('website') }}/assets/images/client-01.png" title="4" alt="4">
                        </div>

                        <div class="partner-item">
                            <img src="{{ asset('website') }}/assets/images/client-01.png" title="5" alt="5">
                        </div>
