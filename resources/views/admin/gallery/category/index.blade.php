        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between">
                    ...
                    <a href="{{ route('gallery-category.create') }}" class="btn btn-dark btn-sm"><i
                            class="dripicons-plus"></i> Create Category</a>
                </div>
                <div class="card-body">
                                ...
                                <tr>
                                    ...
                                    <td class="table-action">
                                        ...
                                        <div class="dropdown-menu">
                                            <a href="{{ route('gallery-category.show', $gallery_category->galcate_slug) }}"
                                                class="dropdown-item"> <i class="mdi mdi-eye"></i> Show</a>
                                            <a href="{{ route('gallery-category.edit', $gallery_category->galcate_slug) }}"
                                                class="dropdown-item"> <i class="mdi mdi-pencil"></i> Edit</a>
                                            <a href="#" data-bs-toggle="modal"
                                                data-value="{{ $gallery_category->galcate_id }}"
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                <form
                                                    action="{{ route('gallery-category.destroy', $gallery_category->galcate_slug) }}"
                                                    method="post">
                                                    @csrf
                                                    @method('DELETE')
