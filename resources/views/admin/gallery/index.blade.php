        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between">
                    ...
                    <a href="{{ route('gallery.create') }}" class="btn btn-dark btn-sm"><i class="dripicons-plus"></i>
                        Create Gallery</a>
                </div>
                <div class="card-body">
                                ...
                                <tr>
                                    ...
                                    <td class="table-action">
                                        ...
                                        <div class="dropdown-menu">
                                            <a href="{{ route('gallery.show', $gallery->gallery_slug) }}"
                                                class="dropdown-item"> <i class="mdi mdi-eye"></i> Show</a>
                                            <a href="{{ route('gallery.edit', $gallery->gallery_slug) }}"
