                        ...
                        @foreach ($partners as $partner)
                            <tr>
                                ...
                                <td class="table-action">
                                    ...
                                    <a href="{{ route('partner.show',$partner->partner_slug) }}" class="dropdown-item"> <i class="mdi mdi-eye"></i> Show</a>
                                    <a href="{{ route('partner.edit',$partner->partner_slug) }}" class="dropdown-item"> <i class="mdi mdi-pencil"></i> Edit</a>
