        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between">
                    ...
                    <a href="{{ route('partner.create') }}" class="btn btn-dark btn-sm"><i class="uil-plus-square"></i>
                        Create Partner</a>
                </div>
                <div class="card-body">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if ($partner->partner_logo)
                                            <img src="{{ asset('uploads/partner/' . $partner->partner_logo) }}"
                                    ...
                                    <td class="table-action">
                                        ...
                                        <div class="dropdown-menu">
                                            <a href="{{ route('partner.show', $partner->partner_slug) }}"
                                                class="dropdown-item"> <i class="mdi mdi-eye"></i> Show</a>
                                            <a href="{{ route('partner.edit', $partner->partner_slug) }}"
                                                class="dropdown-item"> <i class="mdi mdi-pencil"></i> Edit</a>
                                            <a href="#" data-bs-toggle="modal" data-value="{{ $partner->partner_id }}"
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                <form action="{{ route('partner.destroy', $partner->partner_slug) }}"
                                                    method="post">
                                                    @csrf
                                                    @method('DELETE')
