                        ...
                        @foreach ($contactmessages as $contactmessage)
                            <tr>
                                ...
                                <td class="table-action">
                                    ...
                                    <a href="{{ route('contact-message.show',$contactmessage->cm_slug) }}" class="dropdown-item"> <i class="mdi mdi-eye"></i> Show</a>
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            <form action="{{ route('contact-message.destroy',$contactmessage->cm_slug) }}" method="post">
                                                @csrf
                                                @method('DELETE')
