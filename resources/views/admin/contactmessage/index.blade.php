        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <strong class="fs-4"> <i class="uil-comments-alt"></i> All Contact Message
                        Information</strong>
                </div>
                <div class="card-body">
                                ...
                                <tr>
                                    ...
                                    <td class="table-action">
                                        ...
                                        <div class="dropdown-menu">
                                            <a href="{{ route('contact-message.show', $contactmessage->cm_slug) }}"
                                                class="dropdown-item"> <i class="mdi mdi-eye"></i> Show</a>
                                            <a href="#" data-bs-toggle="modal" data-value="{{ $contactmessage->cm_id }}"
                                                data-bs-target="#deleteModal"
                                                class=" text-danger delete-modal dropdown-item">
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                <form
                                                    action="{{ route('contact-message.destroy', $contactmessage->cm_slug) }}"
                                                    method="post">
                                                    @csrf
                                                    @method('DELETE')
