        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between">
                    <strong class="fs-4"> <i class="uil-briefcase"></i> All Content Information</strong>
                    <a href="#" class="btn btn-dark btn-sm"><i class="uil-plus-square"></i>
                        Create content</a>
                </div>
                <div class="card-body">
                        ...
                        <tbody>
                            @foreach ($contents as $data)
                                <tr>
                                    ...
                                    <td>{{ $data['content_order'] }}</td>
                                    <td>
                                        @if ($data->content_image)
                                            <img src="{{ asset('uploads/content/' . $data['content_image']) }}"
                                    ...
                                    <td class="table-action">
                                        ...
                                        <div class="dropdown-menu">
                                            <a href="{{ route('content.show', $data->content_slug) }}"
                                                class="dropdown-item"> <i class="mdi mdi-eye"></i> Show</a>
                                            <a href="{{ route('content.edit', $data->content_slug) }}"
                                                class="dropdown-item"> <i class="mdi mdi-pencil"></i> Edit</a>
                                            <a href="#" data-bs-toggle="modal" data-value="{{ $data->content_id }}"
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                <form action="{{ route('content.destroy', $data->content_slug) }}"
                                                    method="post">
                                                    @csrf
                                                    @method('DELETE')
