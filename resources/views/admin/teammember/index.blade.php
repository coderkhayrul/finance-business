        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between">
                    ...
                    <a href="{{ route('team-member.create') }}" class="btn btn-dark btn-sm"><i
                            class="uil-plus-square"></i> Create Team-Member</a>
                </div>
                <div class="card-body">
                        ...
                        <tbody>
                            @foreach ($teammember as $data)
                                <tr>
                                    ...
                                    <td>
                                        @if ($data->team_image)
                                            <img src="{{ asset('uploads/teammember/' . $data['team_image']) }}"
                                                alt="image" class="img-fluid avatar-sm rounded">
                                        @else
                                    ...
                                    <td class="table-action">
                                        ...
                                        <div class="dropdown-menu">
                                            <a href="{{ route('team-member.show', $data->team_slug) }}"
                                                class="dropdown-item"> <i class="mdi mdi-eye"></i> Show</a>
                                            <a href="{{ route('team-member.edit', $data->team_slug) }}"
                                                class="dropdown-item"> <i class="mdi mdi-pencil"></i> Edit</a>
                                            <a href="#" data-bs-toggle="modal" data-value="{{ $data->team_id }}"
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                <form action="{{ route('team-member.destroy', $data->team_slug) }}"
                                                    method="post">
                                                    @csrf
                                                    @method('DELETE')
