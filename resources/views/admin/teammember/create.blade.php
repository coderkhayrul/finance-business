...
<div class="row">
    <div class="col-md-12">
        <div class="card">
            <form class="form-horizontal" action="{{ route('team-member.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <div class="card-body">
                    <div class="row mb-3 mt-3">
                        ...
                        <div class="col-9">
                            <input type="text" value="{{ old('team_name') }}" class="form-control @error('team_name') is-invalid @enderror" id="team_name" name="team_name" placeholder="Team Member Name">
                            @error('team_name')
                    ...
                    <div class="row mb-3 mt-3">
                        <label for="name" class="col-3 col-form-label">Designation <strong
                                class="text-danger">*</strong></label>
                        <div class="col-9">
                            <input type="text" value="{{ old('team_designation') }}" class="form-control @error('team_designation') is-invalid @enderror" id="team_designation" name="team_designation" placeholder="Enter Designation">
                    ...
                    <div class="row mb-3 mt-3">
                        ...
                        <div class="col-9">
                            <div class="input-group flex-nowrap">
                                ...
                                name="team_linkedin" value="{{ old('team_linkedin') }}">
                                @error('team_linkedin')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                    ...
                    <div class="row mb-3 mt-3">
                        ...
                        <div class="col-9">
                            <div class="input-group flex-nowrap">
                                ...
                                name="team_instragram" value="{{ old('team_instragram') }}">
                    ...
                    <div class="row mb-3">
                        <label for="feedback" class="col-3 col-form-label">Remarks <strong
                                class="text-danger">*</strong></label>
                        <div class="col-9">
                            <textarea class="form-control @error('team_remarks') is-invalid @enderror" placeholder="Leave a remaks here" name="team_remarks" id="team_remarks" style="height: 100px" value="{{ old('team_remarks') }}"></textarea>
                            @error('team_remarks')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                ...
                <div class="card-footer bg-dark row justify-content-md-center">
                    <div class="col col-lg-3">
                        ...
                        <span>TeamMember Save</span> </button>
                    </div>
                </div>
            </form>
        </div>
