        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between">
                    ...
                    <a href="{{ route('service.create') }}" class="btn btn-dark btn-sm"><i class="uil-plus-square"></i>
                        Create Service</a>
                </div>
                <div class="card-body">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if ($data->service_image)
                                            <img src="{{ asset('uploads/service/' . $data['service_image']) }}"
                                    ...
                                    <td class="table-action">
                                        ...
                                        <div class="dropdown-menu">
                                            <a href="{{ route('service.show', $data->service_slug) }}"
                                                class="dropdown-item"> <i class="mdi mdi-eye"></i> Show</a>
                                            <a href="{{ route('service.edit', $data->service_slug) }}"
                                                class="dropdown-item"> <i class="mdi mdi-pencil"></i> Edit</a>
                                            <a href="#" data-bs-toggle="modal" data-value="{{ $data->service_id }}"
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                <form action="{{ route('service.destroy', $data->service_slug) }}"
                                                    method="post">
                                                    @csrf
                                                    @method('DELETE')
