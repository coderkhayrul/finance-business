        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between">
                    ...
                    <a href="{{ route('client.create') }}" class="btn btn-dark btn-sm"><i class="uil-plus-square"></i>
                        Create Client</a>
                </div>
                <div class="card-body">
                                ...
                                <tr>
                                    ...
                                    <td class="table-action">
                                        ...
                                        <div class="dropdown-menu">
                                            <a href="{{ route('client.show', $data->client_slug) }}"
                                                class="dropdown-item"> <i class="mdi mdi-eye"></i> Show</a>
                                            <a href="{{ route('client.edit', $data->client_slug) }}"
                                                class="dropdown-item"> <i class="mdi mdi-pencil"></i> Edit</a>
                                            <a href="#" data-bs-toggle="modal" data-value="{{ $data->client_id }}"
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                <form action="{{ route('client.destroy', $data->client_slug) }}"
                                                    method="post">
                                                    @csrf
                                                    @method('DELETE')
