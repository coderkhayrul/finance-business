        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-header d-flex justify-content-between">
                    ...
                    <a href="{{ route('user.create') }}" class="btn btn-dark btn-sm"><i class="dripicons-user"></i> Create
                        User</a>
                </div>
                <div class="card-body">
                        ...
                        <tbody>
                            @foreach ($users as $user)
                                <tr>
                                    <td>
                                        @if ($user->photo)
                                            <img src="{{ asset('uploads/users/' . $user->photo) }}" alt="image"
                                                class="img-fluid avatar-sm rounded">
                                        @else
                                            <img src="{{ asset('uploads/avatar.png') }}" alt="image"
                                                class="img-fluid avatar-sm rounded">
                                        @endif
                                    </td>
                                    <td>{{ $user->name }}</td>
                                    ...
                                    <td class="table-action">
                                        ...
                                        <div class="dropdown-menu">
                                            <a href="{{ route('user.show', $user->id) }}"
                                                class="dropdown-item text-primary"> <i class="mdi mdi-eye"></i> Show</a>
                                            <a href="{{ route('user.edit', $user->id) }}" class="dropdown-item"> <i
                                                    class="mdi mdi-pencil"></i> Edit</a>
                                            <a href="javascript:void(0);" data-bs-toggle="modal"
                                                data-value="{{ $user->id }}" data-bs-target="#deleteModal"
                                                class="dropdown-item text-danger delete-modal"> <i
