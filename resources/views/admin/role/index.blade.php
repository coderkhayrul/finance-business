        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-header d-flex justify-content-between">
                    ...
                    <a href="{{ route('role.create') }}" class="btn btn-dark btn-sm"><i class="dripicons-tags"></i> Create
                        Role</a>
                </div>
                <div class="card-body">
                                ...
                                <tr>
                                    ...
                                    <td class="table-action">
                                        ...
                                        <div class="dropdown-menu">
                                            <a href="{{ route('role.edit', $role->role_slug) }}" class="dropdown-item">
                                                <i class="mdi mdi-pencil"></i> Edit</a>

                                            <a href="#" class="dropdown-item text-danger" title="Delete"
