...
@section('admin-content')
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                <form class="form-horizontal" action="{{ route('project-category.store') }}" method="POST"
                    enctype="multipart/form-data">
                    @csrf
                    <div class="card-header d-flex justify-content-between">
                        <strong class="fs-4"> <i class="uil-chart-pie"></i> New Category Create</strong>
                    ...
                    <div class="card-body">
                        <div class="row mb-3 mt-3">
                            ...
                            <div class="col-9">
                                <input type="text" value="{{ old('team_name') }}"
                                    ...
                                    name="procate_name" placeholder="Project Category Name">
                                @error('procate_name')
                        ...
                        <div class="row mb-3">
                            <label for="email" class="col-3 col-form-label">Order By <strong
                                    class="text-danger">*</strong></label>
                            <div class="col-9">
                                <input type="number" value="{{ old('procate_order') }}"
                                    class="form-control @error('procate_order') is-invalid @enderror" id="procate_order"
                                    name="procate_order" placeholder="Project Category Order">
                                @error('procate_order')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-9">
                                <textarea class="form-control @error('procate_remarks') is-invalid @enderror"
                                    ...
                                    style="height: 100px" value="{{ old('procate_remarks') }}"></textarea>
