            ...
            <div class="card">
                <form class="form-horizontal" action="{{ route('project.store') }}" method="POST"
                    ...
                    <div class="card-header d-flex justify-content-between">
                        <strong class="fs-4"> <i class="uil-bag"></i> New Project Create</strong>
                        <a href="{{ route('project.index') }}" class="btn btn-dark btn-sm"><i class="uil-bag"></i>
                            All Project</a>
                    </div>
                    <div class="card-body">
                        ...
                        <div class="row mb-3 mt-3">
                            <label for="name" class="col-3 col-form-label">Project Url <strong
                                    class="text-danger">*</strong></label>
                            <div class="col-9">
                                <input type="text" value="{{ old('project_url') }}"
                        ...
                        <div class="row mb-3">
                            <label for="email" class="col-3 col-form-label">Order By <strong
                                    class="text-danger">*</strong></label>
                            <div class="col-9">
                                <input type="number" value="{{ old('project_order') }}"
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-9">
                                <textarea class="form-control @error('project_remarks') is-invalid @enderror"
                                    placeholder="Leave a remarks here" name="project_remarks" id="project_remarks"
                                    style="height: 100px" value="{{ old('project_remarks') }}"></textarea>
                            ...
                            <div class="col-9">
                                <select class="form-select mb-3 @error('procate_id') is-invalid @enderror"
                                    ...
                                    @foreach ($datas as $data)
                                        <option value="{{ $data->procate_id }}">{{ $data->procate_name }}</option>
                                    @endforeach
                                </select>
                                @error('procate_id')
                                    <div class="invalid-feedback">
