        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between">
                    ...
                    <a href="{{ route('banner.create') }}" class="btn btn-dark btn-sm"><i class="dripicons-plus"></i>
                        Create Banner</a>
                </div>
                <div class="card-body">
                        ...
                        <tbody>
                            @foreach ($banners as $banner)
                                <tr>
                                    <td>
                                        @if ($banner->ban_image)
                                            <img src="{{ asset('uploads/banner/' . $banner->ban_image) }}" alt="image"
                                    ...
                                    <td class="table-action">
                                        ...
                                        <div class="dropdown-menu">
                                            <a href="{{ route('banner.show', $banner->ban_slug) }}"
                                                class="dropdown-item">
                                                <i class="mdi mdi-eye"></i> Show</a>
                                            <a href="{{ route('banner.edit', $banner->ban_slug) }}"
                                                class="dropdown-item">
                                                <i class="mdi mdi-pencil"></i> Edit</a>
                                            <a href="#" data-bs-toggle="modal" data-value="{{ $banner->ban_id }}"
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                <form action="{{ route('banner.destroy', $banner->ban_slug) }}"
                                                    method="post">
                                                    @csrf
                                                    @method('DELETE')
